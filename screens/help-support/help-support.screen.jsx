...
const styles = StyleSheet.create({
  ...
  buttonLabel: { color: '#fff', fontFamily: "TT-Octosquares-Medium", fontSize: fontSizes.FONT13 },
  buttonSub: { color: '#666', fontSize: fontSizes.FONT11, fontFamily: "TT-Octosquares-Medium" },
