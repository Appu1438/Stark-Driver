...
export default function HomeScreen() {
    ...
    async function registerForPushNotificationsAsync() {
        try {
            ...
            // Only permission result is shown to driver
            if (finalStatus !== "granted") {
                Toast.show("Notification permission was not granted", {
                    type: "danger",
                });

                console.log("Driver notification permission:", finalStatus);
                return;
            }
            ...
            console.log("Driver notification permission granted");
            ...
            console.log("Driver Expo Project ID:", projectId);
            ...
            if (!pushTokenString) {
                console.log("Failed to generate driver Expo push token");
                return;
            }

            console.log("DRIVER EXPO PUSH TOKEN:", pushTokenString);

            // Save token to backend
            await axiosInstance.put("/driver/update-push-token", {
                token: pushTokenString,
            });

            console.log("Driver push token saved successfully");

        } catch (error) {
            console.log(
                "Driver push notification registration error:",
                error
            );
        }
    }
